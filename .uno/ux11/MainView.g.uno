...
public partial class MainView: Fuse.App
{
    ...
    void InitializeUX()
    {
        ...
        var temp28 = new global::Fuse.Drawing.StaticSolidColor(float4(0.9333333f, 0.9333333f, 0.9333333f, 1f));
        ...
        var temp31 = new global::WelcomeText();
        var temp32 = new global::Fuse.Drawing.StaticSolidColor(float4(0.6705883f, 0.7176471f, 0.7176471f, 1f));
        ...
        var temp36 = new global::Fuse.Drawing.StaticSolidColor(float4(0.9490196f, 0.945098f, 0.9372549f, 1f));
        ...
        var temp52 = new global::TabIcon();
        var temp53 = new global::Fuse.Gestures.Clicked();
        var temp54 = new global::Fuse.Triggers.Actions.Set<Fuse.Visual>(navigation_Active_inst);
        page4Tab = new global::Fuse.Controls.Panel();
        var temp55 = new global::TabIcon();
        ...
        var temp61 = new global::Fuse.Drawing.StaticSolidColor(float4(0.7411765f, 0.7647059f, 0.7803922f, 1f));
        ...
        page2.Background = temp32;
        page2.Children.Add(temp29);
        page2.Children.Add(temp31);
        temp29.Threshold = 0.5f;
        temp29.Actions.Add(temp30);
        temp30.Value = page2Tab;
        temp31.Value = "Welcome to Page 2";
        page3.Name = __selector6;
        page3.Background = temp36;
        page3.Children.Add(temp33);
        page3.Children.Add(temp35);
        temp33.Threshold = 0.5f;
        temp33.Actions.Add(temp34);
        temp34.Value = page3Tab;
        temp35.Value = "Welcome to Page 3";
        page4.Name = __selector7;
        page4.Background = temp40;
        page4.Children.Add(temp37);
        page4.Children.Add(temp39);
        temp37.Threshold = 0.5f;
        temp37.Actions.Add(temp38);
        temp38.Value = page4Tab;
        temp39.Value = "Welcome to Page 4";
        page5.Name = __selector8;
        page5.Background = temp44;
        page5.Children.Add(temp41);
        page5.Children.Add(temp43);
        temp41.Threshold = 0.5f;
        temp41.Actions.Add(temp42);
        temp42.Value = page5Tab;
        temp43.Value = "Welcome to Page 5";
        ...
        temp45.Children.Add(page1Tab);
        temp45.Children.Add(page2Tab);
        temp45.Children.Add(page3Tab);
        temp45.Children.Add(page4Tab);
        temp45.Children.Add(page5Tab);
        page1Tab.Name = __selector9;
        page1Tab.Children.Add(temp46);
        temp46.File = new global::Uno.UX.BundleFileSource(import global::Uno.IO.BundleFile("../../flight.png"));
        temp46.Children.Add(temp47);
        temp47.Actions.Add(temp48);
        temp48.Value = page1;
        page2Tab.Name = __selector10;
        page2Tab.Children.Add(temp49);
        temp49.File = new global::Uno.UX.BundleFileSource(import global::Uno.IO.BundleFile("../../baggage.png"));
        temp49.Children.Add(temp50);
        temp50.Actions.Add(temp51);
        temp51.Value = page2;
        page3Tab.Name = __selector11;
        page3Tab.Children.Add(temp52);
        temp52.File = new global::Uno.UX.BundleFileSource(import global::Uno.IO.BundleFile("../../offers.png"));
        temp52.Children.Add(temp53);
        temp53.Actions.Add(temp54);
        temp54.Value = page3;
        page4Tab.Name = __selector12;
        page4Tab.Children.Add(temp55);
        temp55.File = new global::Uno.UX.BundleFileSource(import global::Uno.IO.BundleFile("../../account.png"));
        temp55.Children.Add(temp56);
        temp56.Actions.Add(temp57);
        temp57.Value = page4;
        page5Tab.Name = __selector13;
        page5Tab.Children.Add(temp58);
        temp58.File = new global::Uno.UX.BundleFileSource(import global::Uno.IO.BundleFile("../../more.png"));
