...
void Gesture::OnPointerMoved(uObject* sender, ::g::Fuse::Input::PointerMovedArgs* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::g::Uno::String::op_Addition1(::STRINGS[9/*"Missing Los...*/], uBox<int>(::g::Uno::Int_typeof(), uPtr(args)->PointIndex())), this, ::STRINGS[2/*"C:\\Users\\...*/], 768, ::STRINGS[10/*"OnPointerMo...*/]);
        LostCapture(true);
        return;
    }
...
bool Pointer::ExtendCapture(uObject* identity, int pointIndex)
{
    ...
    if (c == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[14/*"Attempting ...*/], identity, ::STRINGS[2/*"C:\\Users\\...*/], 1736, ::STRINGS[15/*"ExtendCapture"*/]);
        return false;
    }
...
bool Pointer::ModifyCapture(uObject* identity, int type)
{
    ...
    if (c == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[16/*"Attempting ...*/], identity, ::STRINGS[2/*"C:\\Users\\...*/], 1714, ::STRINGS[17/*"ModifyCapture"*/]);
        return false;
    }
...
bool Pointer::ModifyCapture1(uObject* identity, ::g::Fuse::Visual* visual, uDelegate* lostCallback, int type, int pointIndex)
{
    ...
    if (c != NULL)
    {
        if (uPtr(c)->Visual() != visual)
            ::g::Fuse::Diagnostics::InternalError(::STRINGS[21/*"Cannot modi...*/], identity, ::STRINGS[2/*"C:\\Users\\...*/], 1688, ::STRINGS[17/*"ModifyCapture"*/]);
    }
    else
    {
