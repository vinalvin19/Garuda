...
// C:\Users\Lotus\AppData\Local\Fusetools\Packages\Fuse.Selection\1.2.0\$.uno
// --------------------------------------------------------------------------
...
static void Selectable_build(uType* type)
{
    ...
    ::STRINGS[5] = uString::Const("C:\\Users\\Lotus\\AppData\\Local\\Fusetools\\Packages\\Fuse.Selection\\1.2.0\\$.uno");
...
void Selectable__OnRooted_fn(Selectable* __this)
{
    ...
    if (__this->_selection == NULL)
        ::g::Fuse::Diagnostics::UserError(::STRINGS[8/*"Unable to l...*/], __this, ::STRINGS[5/*"C:\\Users\\...*/], 116, ::STRINGS[9/*"OnRooted"*/], NULL);
}
...
void Selectable::Add1()
{
    if (_selection == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[6/*"No selectio...*/], this, ::STRINGS[5/*"C:\\Users\\...*/], 157, ::STRINGS[7/*"Add"*/], NULL);
        return;
    }
...
void Selectable::Remove1()
{
    if (_selection == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[6/*"No selectio...*/], this, ::STRINGS[5/*"C:\\Users\\...*/], 171, ::STRINGS[11/*"Remove"*/], NULL);
        return;
    }
...
void Selectable::Toggle()
{
    if (_selection == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[6/*"No selectio...*/], this, ::STRINGS[5/*"C:\\Users\\...*/], 185, ::STRINGS[13/*"Toggle"*/], NULL);
        return;
    }
...
void Selectable::add(::g::Fuse::Scripting::Context* c, Selectable* s, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[4/*"add require...*/], s, ::STRINGS[5/*"C:\\Users\\...*/], 30, ::STRINGS[1/*"add"*/], NULL);
        return;
    }
...
void Selectable::remove(::g::Fuse::Scripting::Context* c, Selectable* s, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[10/*"remove requ...*/], s, ::STRINGS[5/*"C:\\Users\\...*/], 48, ::STRINGS[2/*"remove"*/], NULL);
        return;
    }
...
void Selectable::toggle(::g::Fuse::Scripting::Context* c, Selectable* s, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[12/*"toggle requ...*/], s, ::STRINGS[5/*"C:\\Users\\...*/], 64, ::STRINGS[3/*"toggle"*/], NULL);
        return;
    }
...
static void Selection_build(uType* type)
{
    ...
    ::STRINGS[21] = uString::Const("remove requires 1 argument, the value of the item");
    ::STRINGS[22] = uString::Const("toggle requires 1 argument, the value of them item");
    ::STRINGS[23] = uString::Const("MaxCount must >= 1");
    ::STRINGS[24] = uString::Const("set_MaxCount");
    ::TYPES[0] = ::g::Uno::Type_typeof();
    ::TYPES[1] = ::g::Fuse::Scripting::ScriptMember_typeof()->Array();
    ...
    ::TYPES[8] = ::g::Fuse::Reactive::IObservable_typeof();
    ::TYPES[9] = ::g::Fuse::Reactive::ISubscription_typeof();
    ...
    type->SetInterfaces(
        ...
        ::g::Fuse::Reactive::IObserver_typeof(), offsetof(Selection_type, interface4));
    type->SetFields(11,
        ...
        ::TYPES[8/*Fuse.Reactive.IObservable*/], offsetof(::g::Fuse::Selection::Selection, _observableValues), 0,
        ::g::Fuse::Selection::SelectionReplace_typeof(), offsetof(::g::Fuse::Selection::Selection, _replace), 0,
        ::TYPES[9/*Fuse.Reactive.ISubscription*/], offsetof(::g::Fuse::Selection::Selection, _subscription), 0,
...
void Selection::MaxCount(int value)
{
    ...
    if (value < 1)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[23/*"MaxCount mu...*/], this, ::STRINGS[5/*"C:\\Users\\...*/], 553, ::STRINGS[24/*"set_MaxCount"*/], NULL);
        return;
    }
...
void Selection::OnObservableValuesChanged()
{
    ...
    _subscription = ::g::Fuse::Reactive::IObservable::Subscribe(uInterface(uPtr(_observableValues), ::TYPES[8/*Fuse.Reactive.IObservable*/]), (uObject*)this);
}
...
void Selection::OnSelectionChanged(int how)
{
    ...
    if ((how == 0) && (_subscription != NULL))
        ::g::Fuse::Reactive::ISubscription::ReplaceAllExclusive(uInterface(uPtr(_subscription), ::TYPES[9/*Fuse.Reactive.ISubscription*/]), (uObject*)Selection__ListWrapper::New1(_values));
}
...
void Selection::add(::g::Fuse::Scripting::Context* c, Selection* s, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[17/*"add require...*/], s, ::STRINGS[5/*"C:\\Users\\...*/], 342, ::STRINGS[1/*"add"*/], NULL);
        return;
    }
...
void Selection::clear(::g::Fuse::Scripting::Context* c, Selection* s, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[18/*"clear requi...*/], s, ::STRINGS[5/*"C:\\Users\\...*/], 324, ::STRINGS[14/*"clear"*/], NULL);
        return;
    }
...
void Selection::forceAdd(::g::Fuse::Scripting::Context* c, Selection* s, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[19/*"forceAdd re...*/], s, ::STRINGS[5/*"C:\\Users\\...*/], 374, ::STRINGS[15/*"forceAdd"*/], NULL);
        return;
    }
...
void Selection::forceRemove(::g::Fuse::Scripting::Context* c, Selection* s, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[20/*"forceRemove...*/], s, ::STRINGS[5/*"C:\\Users\\...*/], 388, ::STRINGS[16/*"forceRemove"*/], NULL);
        return;
    }
...
void Selection::remove(::g::Fuse::Scripting::Context* c, Selection* s, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[21/*"remove requ...*/], s, ::STRINGS[5/*"C:\\Users\\...*/], 360, ::STRINGS[2/*"remove"*/], NULL);
        return;
    }
...
void Selection::toggle(::g::Fuse::Scripting::Context* c, Selection* s, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[22/*"toggle requ...*/], s, ::STRINGS[5/*"C:\\Users\\...*/], 404, ::STRINGS[3/*"toggle"*/], NULL);
        return;
    }
...
{
    ::STRINGS[25] = uString::Const("Unable to locate Selectable");
    ::STRINGS[5] = uString::Const("C:\\Users\\Lotus\\AppData\\Local\\Fusetools\\Packages\\Fuse.Selection\\1.2.0\\$.uno");
    ::STRINGS[26] = uString::Const("Perform");
    type->SetFields(8,
...
void ToggleSelection__Perform_fn(ToggleSelection* __this, ::g::Fuse::Node* target)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[25/*"Unable to l...*/], __this, ::STRINGS[5/*"C:\\Users\\...*/], 965, ::STRINGS[26/*"Perform"*/], NULL);
        return;
    }
