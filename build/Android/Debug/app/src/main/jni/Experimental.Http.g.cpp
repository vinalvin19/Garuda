...
// C:\Users\Lotus\AppData\Local\Fusetools\Packages\Experimental.Http\1.2.0\$.uno
// -----------------------------------------------------------------------------
...
static void Loader_build(uType* type)
{
    ...
    ::STRINGS[9] = uString::Const("C:/Users/Lotus/AppData/Local/Fusetools/Packages/Experimental.Http/1.2.0/$.uno");
...
bool Loader::LoadCache(uObject* record)
{
    ...
    {
        ::g::Uno::Exception* e = __t.Exception;
        ::g::Uno::Diagnostics::Debug::Log2(e, 0, ::STRINGS[9/*"C:/Users/Lo...*/], 853);
        ::g::Uno::Diagnostics::Debug::Log5(::g::Uno::String::op_Addition2(::STRINGS[10/*"Failed load...*/], Uri), 0, ::STRINGS[9/*"C:/Users/Lo...*/], 854);
