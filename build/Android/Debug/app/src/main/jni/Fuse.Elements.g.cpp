...
// C:\Users\Lotus\AppData\Local\Fusetools\Packages\Fuse.Elements\1.2.0\$.uno
// -------------------------------------------------------------------------
...
// C:\Users\Lotus\AppData\Local\Fusetools\Packages\Fuse.Elements\1.2.0\caching\$.uno
// ---------------------------------------------------------------------------------
...
static void Element_build(uType* type)
{
    ...
    ::STRINGS[7] = uString::Const("C:/Users/Lotus/AppData/Local/Fusetools/Packages/Fuse.Elements/1.2.0/$.uno");
    ...
    ::STRINGS[9] = uString::Const("C:\\Users\\Lotus\\AppData\\Local\\Fusetools\\Packages\\Fuse.Elements\\1.2.0\\$.uno");
    ...
    type->SetInterfaces(
        ...
        ::g::Fuse::ITemplateSource_typeof(), offsetof(Element_type, interface6),
        ::TYPES[15/*Uno.Collections.ICollection<Fuse.Node>*/], offsetof(Element_type, interface7),
        ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL), offsetof(Element_type, interface8),
        ::g::Fuse::Triggers::Actions::IShow_typeof(), offsetof(Element_type, interface9),
        ::g::Fuse::Triggers::Actions::IHide_typeof(), offsetof(Element_type, interface10),
        ::g::Fuse::Triggers::Actions::ICollapse_typeof(), offsetof(Element_type, interface11),
        ::g::Fuse::IActualPlacement_typeof(), offsetof(Element_type, interface12),
        ::g::Fuse::Animations::IResize_typeof(), offsetof(Element_type, interface13));
    type->SetFields(59,
...
Element_type* Element_typeof()
{
    ...
    type->interface9.fp_Show = (void(*)(uObject*))Element__FuseTriggersActionsIShowShow_fn;
    type->interface11.fp_Collapse = (void(*)(uObject*))Element__FuseTriggersActionsICollapseCollapse_fn;
    type->interface10.fp_Hide = (void(*)(uObject*))Element__FuseTriggersActionsIHideHide_fn;
    type->interface13.fp_SetSize = (void(*)(uObject*, ::g::Uno::Float2*))Element__FuseAnimationsIResizeSetSize_fn;
    type->interface12.fp_get_ActualSize = (void(*)(uObject*, ::g::Uno::Float3*))Element__FuseIActualPlacementget_ActualSize_fn;
    type->interface12.fp_add_Placed = (void(*)(uObject*, uDelegate*))Element__add_Placed_fn;
    type->interface12.fp_remove_Placed = (void(*)(uObject*, uDelegate*))Element__remove_Placed_fn;
...
void Element__Draw_fn(Element* __this, ::g::Fuse::DrawContext* dc)
{
    if (!__this->IsRootingCompleted())
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[12/*"Draw called...*/], __this, ::STRINGS[9/*"C:\\Users\\...*/], 940, ::STRINGS[13/*"Draw"*/]);
...
void Element__OnArrangeMarginBox_fn(Element* __this, ::g::Uno::Float2* position, ::g::Fuse::LayoutParams* lp, ::g::Uno::Float2* __retval)
{
    ...
    if (bp.SanityConstrain())
    {
        if (!Element::_invalidValuesWarn())
            ::g::Fuse::Diagnostics::InternalError(::STRINGS[14/*"Invalid val...*/], __this, ::STRINGS[9/*"C:\\Users\\...*/], 2113, ::STRINGS[15/*"OnArrangeMa...*/]);
...
::g::Uno::Graphics::Framebuffer* Element::CaptureRegion(::g::Fuse::DrawContext* dc, ::g::Uno::Rect region, ::g::Uno::Float2 padding)
{
    ...
    {
        ::g::Uno::Diagnostics::Debug::Log5(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[5/*"CaptureRegi...*/], uBox(::g::Uno::Int2_typeof(), fsz)), ::STRINGS[6/*", max-size: "*/]), uBox<int>(::g::Uno::Int_typeof(), ::g::Uno::Graphics::Texture2D::MaxSize())), 0, ::STRINGS[7/*"C:/Users/Lo...*/], 913);
        return NULL;
    }
...
void Element::Composit(::g::Fuse::DrawContext* dc)
{
    ...
    if (!flat && !_warnOpacityFlat)
    {
        ...
        ::g::Fuse::Diagnostics::UserWarning(::STRINGS[8/*"This elemen...*/], this, ::STRINGS[9/*"C:\\Users\\...*/], 1119, ::STRINGS[10/*"Composit"*/]);
    }
    ...
    if (!r && !_warnNoCacheDraw)
    {
        ...
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[11/*"This elemen...*/], this, ::STRINGS[9/*"C:\\Users\\...*/], 1127, ::STRINGS[10/*"Composit"*/]);
    }
}
...
// private void FillFramebuffer(Fuse.DrawContext dc, framebuffer fb, bool drawAll, Uno.Rect scissorRectInClipSpace) :786
...
// public static Uno.Rect GetScissorRectInClipSpace(Fuse.DrawContext dc) :762
...
// public framebuffer PinAndValidateFramebuffer(Fuse.DrawContext dc) :767
...
// private static float2 WindowCoordToClipSpace(float2 input, int2 viewportSize) :748
...
// private static Uno.Rect WindowRectToClipSpace(Uno.Rect input, int2 viewportSize) :753
...
// private void FillFramebuffer(Fuse.DrawContext dc, framebuffer fb, bool drawAll, Uno.Rect scissorRectInClipSpace) [instance] :786
...
// public framebuffer PinAndValidateFramebuffer(Fuse.DrawContext dc) [instance] :767
...
// public static Uno.Rect GetScissorRectInClipSpace(Fuse.DrawContext dc) [static] :762
...
// private static float2 WindowCoordToClipSpace(float2 input, int2 viewportSize) [static] :748
...
// private static Uno.Rect WindowRectToClipSpace(Uno.Rect input, int2 viewportSize) [static] :753
...
// internal sealed class ElementBatch :1273
// {
...
// public ElementBatch(Fuse.Elements.ElementBatcher elementBatcher, Fuse.Elements.ElementAtlas elementAtlas) :1284
...
// public void Dispose() :1302
void ElementBatch__Dispose_fn(ElementBatch* __this)
{
    __this->Dispose();
}

// public void Draw(Fuse.DrawContext dc, float4x4 localToClipTransform, Uno.Rect scissorRectInClipSpace) :1412
...
// private void FillIndexBuffer() :1475
void ElementBatch__FillIndexBuffer_fn(ElementBatch* __this)
{
    __this->FillIndexBuffer();
}

// private void FillVertexPositionBuffer(Fuse.DrawContext dc) :1515
...
// private void FillVertexTexCoordBuffer() :1496
void ElementBatch__FillVertexTexCoordBuffer_fn(ElementBatch* __this)
{
    __this->FillVertexTexCoordBuffer();
}

// public static Uno.Recti GetCachingRect(Fuse.Elements.Element elm) :1331
...
// public void RemoveElement(Fuse.Elements.Element elm) :1379
void ElementBatch__RemoveElement_fn(ElementBatch* __this, ::g::Fuse::Elements::Element* elm)
{
    __this->RemoveElement(elm);
}

// public Fuse.VisualBounds get_RenderBounds() :1354
void ElementBatch__get_RenderBounds_fn(ElementBatch* __this, ::g::Fuse::VisualBounds** __retval)
{
    *__retval = __this->RenderBounds();
}

// public ElementBatch(Fuse.Elements.ElementBatcher elementBatcher, Fuse.Elements.ElementAtlas elementAtlas) [instance] :1284
...
// public void AddElement(Fuse.Elements.Element elm) [instance] :1365
...
// private Fuse.VisualBounds CalcRenderBounds() [instance] :1343
...
// public void Dispose() [instance] :1302
...
// public void Draw(Fuse.DrawContext dc, float4x4 localToClipTransform, Uno.Rect scissorRectInClipSpace) [instance] :1412
...
// private void FillIndexBuffer() [instance] :1475
...
// private void FillVertexPositionBuffer(Fuse.DrawContext dc) [instance] :1515
...
// private void FillVertexTexCoordBuffer() [instance] :1496
...
// private generated void init_DrawCalls() [instance] :1273
...
// internal void InvalidateOpacity(Fuse.Elements.Element elm) [instance] :1405
void ElementBatch::InvalidateOpacity(::g::Fuse::Elements::Element* elm)
{
    _vertexPositionBufferValid = false;
}

// public void InvalidateRenderBounds(Fuse.Elements.Element elm) [instance] :1392
...
// internal void InvalidateTransform(Fuse.Elements.Element elm) [instance] :1399
...
// public bool IsFull() [instance] :1470
bool ElementBatch::IsFull()
{
    return (uPtr(_elements)->Count() * 6) >= 65535;
}

// public void RemoveElement(Fuse.Elements.Element elm) [instance] :1379
...
// public Fuse.VisualBounds get_RenderBounds() [instance] :1354
...
// internal static Uno.Recti ConservativelySnapToCoveringIntegers(Uno.Rect r) [static] :1317
...
// public static Uno.Recti GetCachingRect(Fuse.Elements.Element elm) [static] :1331
...
// public ElementBatch New(Fuse.Elements.ElementBatcher elementBatcher, Fuse.Elements.ElementAtlas elementAtlas) [static] :1284
...
// internal sealed class ElementBatchEntry :1208
// {
...
// public ElementBatchEntry(Fuse.Elements.Element elm) :1210
void ElementBatchEntry__ctor__fn(ElementBatchEntry* __this, ::g::Fuse::Elements::Element* elm)
{
    __this->ctor_(elm);
}

// private float GetEffectiveOpacity() :1216
...
// public void OnRemoved() :1256
void ElementBatchEntry__OnRemoved_fn(ElementBatchEntry* __this)
{
    __this->OnRemoved();
}

// public ElementBatchEntry(Fuse.Elements.Element elm) [instance] :1210
...
// private float GetEffectiveOpacity() [instance] :1216
...
// public void InvalidateRenderBounds() [instance] :1241
...
// public void InvalidateTransform() [instance] :1250
...
// public void InvalidateVisual() [instance] :1223
void ElementBatchEntry::InvalidateVisual()
{
    uPtr(_atlas)->InvalidateElement(_elm);
}

// public void InvalidateVisualComposition() [instance] :1228
...
// public void OnRemoved() [instance] :1256
...
// public ElementBatchEntry New(Fuse.Elements.Element elm) [static] :1210
...
// internal sealed class ElementBatcher :879
// {
static void ElementBatcher_build(uType* type)
{
    ...
    ::STRINGS[27] = uString::Const("C:/Users/Lotus/AppData/Local/Fusetools/Packages/Fuse.Elements/1.2.0/caching/$.uno");
...
// public static bool ShouldBatchElementWithCachingMode(Fuse.Elements.CachingMode mode) :985
...
// public static bool ShouldBatchElementWithSize(int2 size) :977
...
// public void AddElement(Fuse.Visual elm) [instance] :911
...
// private Fuse.Elements.ElementAtlas allocAtlas() [instance] :935
...
// private Fuse.Elements.ElementBatch allocBatch(Fuse.Elements.ElementAtlas atlas) [instance] :942
...
// private void DiscardAtlasing() [instance] :949
...
// private void DiscardBatching() [instance] :966
...
// public void Dispose() [instance] :903
...
// public void Draw(Fuse.DrawContext dc) [instance] :1125
...
// private void OnAtlasSizeChanged(object sender, Uno.EventArgs args) [instance] :893
void ElementBatcher::OnAtlasSizeChanged(uObject* sender, ::g::Uno::EventArgs* args)
{
    DiscardAtlasing();
}

// public void Remove(Fuse.Elements.Element elm) [instance] :924
...
// public void RemoveAllElements() [instance] :917
...
// private void UpdateDrawList() [instance] :1014
void ElementBatcher::UpdateDrawList()
{
    ...
    for (::g::Uno::Collections::List__Enumerator<uStrong< ::g::Fuse::Visual*> > enum4 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(_elements), &ret27), ret27); enum4.MoveNext(::TYPES[44/*Uno.Collections.List<Fuse.Visual>.Enumerator*/]); )
    {
        ...
        if (emitNewBatch || (atlas == NULL))
        {
            ...
            {
                ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[26/*"BUG: atlas-...*/], 0, ::STRINGS[27/*"C:/Users/Lo...*/], 1105);
...
// public ElementBatcher New() [static] :887
...
// public static bool ShouldBatchElement(Fuse.Visual node) [static] :990
...
// public static bool ShouldBatchElementWithCachingMode(Fuse.Elements.CachingMode mode) [static] :985
bool ElementBatcher::ShouldBatchElementWithCachingMode(int mode)
{
    return mode != 2;
}

// public static bool ShouldBatchElementWithSize(int2 size) [static] :977
...
// internal abstract interface IElementBatchDrawable :860
// {
...
// internal sealed class SingleVisualDrawable :865
// {
...
// public SingleVisualDrawable(Fuse.Visual elm) :868
void SingleVisualDrawable__ctor__fn(SingleVisualDrawable* __this, ::g::Fuse::Visual* elm)
{
    __this->ctor_(elm);
}

// public void Draw(Fuse.DrawContext dc, float4x4 localToClipTransform, Uno.Rect scissorRectInClipSpace) :873
...
// public SingleVisualDrawable New(Fuse.Visual elm) :868
void SingleVisualDrawable__New1_fn(::g::Fuse::Visual* elm, SingleVisualDrawable** __retval)
{
    *__retval = SingleVisualDrawable::New1(elm);
}

// public SingleVisualDrawable(Fuse.Visual elm) [instance] :868
void SingleVisualDrawable::ctor_(::g::Fuse::Visual* elm)
{
    _elm = elm;
}

// public void Draw(Fuse.DrawContext dc, float4x4 localToClipTransform, Uno.Rect scissorRectInClipSpace) [instance] :873
...
// public SingleVisualDrawable New(Fuse.Visual elm) [static] :868
