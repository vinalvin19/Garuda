...
// C:\Users\Lotus\AppData\Local\Fusetools\Packages\UnoCore\1.2.1\source\uno\ux\$.uno
// ---------------------------------------------------------------------------------
...
void Selector__Equals_fn(Selector* __this, uType* __type, uObject* obj, bool* __retval)
{
    ...
    uString* s = uAs<uString*>(obj, ::TYPES[11/*string*/]);
...
static void SelectorRegistry__cctor__fn(uType* __type)
{
    ...
    SelectorRegistry::_stringToHandle_ = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[12/*Uno.Collections.Dictionary<string, int>*/]));
    SelectorRegistry::_handleToString_ = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[13/*Uno.Collections.Dictionary<int, string>*/]));
    SelectorRegistry::_counter_ = 1;
}

static void SelectorRegistry_build(uType* type)
{
    ::TYPES[12] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::String_typeof(), ::g::Uno::Int_typeof(), NULL);
    ...
    type->SetFields(0,
        ...
        ::TYPES[13/*Uno.Collections.Dictionary<int, string>*/], (uintptr_t)&::g::Uno::UX::SelectorRegistry::_handleToString_, uFieldFlagsStatic,
        uObject_typeof(), (uintptr_t)&::g::Uno::UX::SelectorRegistry::_mutex_, uFieldFlagsStatic,
        ::TYPES[12/*Uno.Collections.Dictionary<string, int>*/], (uintptr_t)&::g::Uno::UX::SelectorRegistry::_stringToHandle_, uFieldFlagsStatic);
}
...
static void Size_build(uType* type)
{
    ...
    type->SetFields(0,
        ::TYPES[14/*float*/], offsetof(::g::Uno::UX::Size, Value), 0,
...
void Size__Equals_fn(Size* __this, uType* __type, uObject* obj, bool* __retval)
{
    ...
    else if (uIs(obj, ::TYPES[14/*float*/]))
    {
        if ((__this->Unit != 2) && (__this->Unit != 1))
            return *__retval = false, void();

        float f = uUnbox<float>(::TYPES[14/*float*/], obj);
...
{
    float ind7;
    return *__retval = ::g::Uno::Float::GetHashCode((ind7 = __this->Value, ind7), ::TYPES[14/*float*/]), void();
}
...
void Size__ToString_fn(Size* __this, uType* __type, uString** __retval)
{
    ...
    {
        case 1:
            return *__retval = ::g::Uno::String::op_Addition2(::g::Uno::Float::ToString((ind1 = __this->Value, ind1), ::TYPES[14/*float*/]), ::STRINGS[5/*" (unspecifi...*/]), void();
        case 2:
            return *__retval = ::g::Uno::String::op_Addition2(::g::Uno::Float::ToString((ind2 = __this->Value, ind2), ::TYPES[14/*float*/]), ::STRINGS[6/*"pt"*/]), void();
        case 3:
            return *__retval = ::g::Uno::String::op_Addition2(::g::Uno::Float::ToString((ind3 = __this->Value, ind3), ::TYPES[14/*float*/]), ::STRINGS[7/*"px"*/]), void();
        case 4:
            return *__retval = ::g::Uno::String::op_Addition2(::g::Uno::Float::ToString((ind4 = __this->Value, ind4), ::TYPES[14/*float*/]), ::STRINGS[8/*"%"*/]), void();
        case 0:
            return *__retval = ::STRINGS[9/*"(auto)"*/], void();
        default:
            return *__retval = ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::Float::ToString((ind5 = __this->Value, ind5), ::TYPES[14/*float*/]), ::STRINGS[10/*" ("*/]), ::g::Uno::Int::ToString((ind6 = __this->Unit, ind6), ::TYPES[15/*int*/])), ::STRINGS[11/*")"*/]), void();
    }
}
...
static void Size2_build(uType* type)
{
    ...
    ::TYPES[16] = ::g::Uno::UX::Size_typeof();
    type->SetFields(0,
        ::TYPES[16/*Uno.UX.Size*/], offsetof(::g::Uno::UX::Size2, X), 0,
        ::TYPES[16/*Uno.UX.Size*/], offsetof(::g::Uno::UX::Size2, Y), 0);
}
...
void Size2__GetHashCode_fn(Size2* __this, uType* __type, int* __retval)
{
    ::g::Uno::UX::Size ind3;
    ::g::Uno::UX::Size ind4;
    return *__retval = (ind3 = __this->X, (&ind3))->GetHashCode(::TYPES[16/*Uno.UX.Size*/]) ^ (ind4 = __this->Y, (&ind4))->GetHashCode(::TYPES[16/*Uno.UX.Size*/]), void();
}
...
void Size2__ToString_fn(Size2* __this, uType* __type, uString** __retval)
{
    ::g::Uno::UX::Size ind1;
    ::g::Uno::UX::Size ind2;
    return *__retval = ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2((ind1 = __this->X, (&ind1))->ToString(::TYPES[16/*Uno.UX.Size*/]), ::STRINGS[12/*", "*/]), (ind2 = __this->Y, (&ind2))->ToString(::TYPES[16/*Uno.UX.Size*/])), void();
}
...
static void StreamExtensions_build(uType* type)
{
    ...
    ::TYPES[18] = ::g::Uno::Byte_typeof()->Array();
}
...
uArray* StreamExtensions::ReadAllBytes(::g::Uno::IO::BinaryReader* reader)
{
...

    {
        const auto __finally_fun = [&]()
        {
            ::g::Uno::IDisposable::Dispose(uInterface(uPtr((uObject*)ms), ::TYPES[17/*Uno.IDisposable*/]));
        };
...
uArray* StreamExtensions::ToArray(::g::Uno::IO::MemoryStream* memoryStream)
{
    ...
    uArray* bytes = uArray::New(::TYPES[18/*byte[]*/], (int)memoryStream->Length());
