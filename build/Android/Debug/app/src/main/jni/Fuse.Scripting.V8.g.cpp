...
// C:\Users\Lotus\AppData\Local\Fusetools\Packages\Fuse.Scripting.V8\1.2.0\$.uno
// -----------------------------------------------------------------------------
...
static void Context_build(uType* type)
{
    ...
    type->SetFields(4,
        ...
        ::g::Uno::Action1_typeof()->MakeType(::g::Fuse::Scripting::V8::Simple::JSScriptException_typeof(), NULL), offsetof(::g::Fuse::Scripting::V8::Context, _errorHandler), 0,
        ::g::Fuse::Scripting::V8::Function_typeof(), offsetof(::g::Fuse::Scripting::V8::Context, _instanceOf), 0,
...
void Context__Evaluate_fn(Context* __this, uString* fileName, uString* code, uObject** __retval)
{
    ...
    if (::g::Uno::String::op_Equality(code, NULL))
        U_THROW(::g::Uno::ArgumentNullException::New6(::STRINGS[1/*"code"*/]));
...
{
    ::STRINGS[2] = uString::Const("__unoHandle");
    ::STRINGS[3] = uString::Const("byteLength");
    ::STRINGS[4] = uString::Const("V8: Unable to get data from ArrayBuffer");
    ::STRINGS[5] = uString::Const("Unhandled type in V8 marshaller: ");
    ::STRINGS[6] = uString::Const(":");
    ::STRINGS[7] = uString::Const("V8 marshaller: The impossible happened.");
    ::TYPES[5] = ::g::Uno::Int_typeof();
    ::TYPES[6] = ::g::Uno::Double_typeof();
    ::TYPES[7] = ::g::Fuse::Scripting::External_typeof();
    ::TYPES[8] = ::g::Fuse::Scripting::V8::ArrayHandle_typeof();
    ::TYPES[9] = ::g::Uno::Float_typeof();
    ::TYPES[10] = ::g::Uno::String_typeof();
    ::TYPES[11] = ::g::Uno::UX::Selector_typeof();
    ::TYPES[12] = ::g::Uno::Bool_typeof();
    ::TYPES[13] = ::g::Uno::Byte_typeof()->Array();
    ::TYPES[14] = ::g::Fuse::Scripting::V8::Object_typeof();
    ::TYPES[15] = ::g::Fuse::Scripting::V8::Array_typeof();
    ::TYPES[16] = ::g::Fuse::Scripting::V8::Function_typeof();
    ::TYPES[17] = ::g::Fuse::Scripting::Callback_typeof();
    ::TYPES[18] = ::g::Fuse::Scripting::V8::V8SimpleExtensions__WrappedCallback_typeof();
    ::TYPES[19] = ::g::Fuse::Scripting::V8::Simple::JSValue_typeof()->Array();
...
::JSValue* Marshaller::NewArrayBuffer(::g::Fuse::Scripting::V8::Context* context, uArray* data, ::g::Fuse::Scripting::V8::AutoReleasePool pool)
{
    ...
    obj->Item(::STRINGS[2/*"__unoHandle"*/], ::g::Fuse::Scripting::External::New1(handle));
...
int Marshaller::ToInt(uObject* o)
{
    ...
    if (uIs(o, ::TYPES[6/*double*/]))
        return (int)uUnbox<double>(::TYPES[6/*double*/], o);
...
uArray* Marshaller::TryGetArrayBufferData(::g::Fuse::Scripting::V8::Context* context, ::g::Fuse::Scripting::V8::Object* o)
{
    ...
    if (o->ContainsKey(::STRINGS[2/*"__unoHandle"*/]))
    {
        ::g::Fuse::Scripting::External* ext = uAs< ::g::Fuse::Scripting::External*>(uPtr(o)->Item(::STRINGS[2/*"__unoHandle"*/]), ::TYPES[7/*Fuse.Scripting.External*/]);
        ::g::Fuse::Scripting::V8::ArrayHandle* handle = (ext == NULL) ? uCast< ::g::Fuse::Scripting::V8::ArrayHandle*>(NULL, ::TYPES[8/*Fuse.Scripting.V8.ArrayHandle*/]) : uAs< ::g::Fuse::Scripting::V8::ArrayHandle*>(uPtr(ext)->Object, ::TYPES[8/*Fuse.Scripting.V8.ArrayHandle*/]);

        if (handle != NULL)
            return uPtr(handle)->Array;
    }

    if (o->ContainsKey(::STRINGS[3/*"byteLength"*/]))
    {
        int len = Marshaller::ToInt(uPtr(o)->Item(::STRINGS[3/*"byteLength"*/]));
        return ::g::Fuse::Scripting::V8::ArrayHandle::CopyToArray(ptr, len);
    }

    U_THROW(::g::Uno::Exception::New2(::STRINGS[4/*"V8: Unable ...*/]));
}
...
::JSValue* Marshaller::Unwrap(::g::Fuse::Scripting::V8::Context* context, uObject* obj, ::g::Fuse::Scripting::V8::AutoReleasePool pool)
{
    ...
    if (uIs(obj, ::TYPES[6/*double*/]))
        return ::g::Fuse::Scripting::V8::V8SimpleExtensions::NewDouble(uUnbox<double>(::TYPES[6/*double*/], obj), pool);

    if (uIs(obj, ::TYPES[9/*float*/]))
        return ::g::Fuse::Scripting::V8::V8SimpleExtensions::NewDouble((double)uUnbox<float>(::TYPES[9/*float*/], obj), pool);

    if (uIs(obj, ::TYPES[10/*string*/]))
        return ::g::Fuse::Scripting::V8::V8SimpleExtensions::AsValue4(::g::Fuse::Scripting::V8::V8SimpleExtensions::NewString(cxt, uCast<uString*>(obj, ::TYPES[10/*string*/]), pool));

    if (uIs(obj, ::TYPES[11/*Uno.UX.Selector*/]))
        return ::g::Fuse::Scripting::V8::V8SimpleExtensions::AsValue4(::g::Fuse::Scripting::V8::V8SimpleExtensions::NewString(cxt, ::g::Uno::UX::Selector__op_Implicit1(uUnbox< ::g::Uno::UX::Selector>(::TYPES[11/*Uno.UX.Selector*/], obj)), pool));

    if (uIs(obj, ::TYPES[12/*bool*/]))
        return ::g::Fuse::Scripting::V8::V8SimpleExtensions::NewBool(uUnbox<bool>(::TYPES[12/*bool*/], obj), pool);

    if (uIs(obj, ::TYPES[13/*byte[]*/]))
        return Marshaller::NewArrayBuffer(context, uCast<uArray*>(obj, ::TYPES[13/*byte[]*/]), pool);

    if (uIs(obj, ::TYPES[14/*Fuse.Scripting.V8.Object*/]))
        return ::g::Fuse::Scripting::V8::V8SimpleExtensions::AsValue3(uPtr(uCast< ::g::Fuse::Scripting::V8::Object*>(obj, ::TYPES[14/*Fuse.Scripting.V8.Object*/]))->GetJSObject(pool));

    if (uIs(obj, ::TYPES[15/*Fuse.Scripting.V8.Array*/]))
        return ::g::Fuse::Scripting::V8::V8SimpleExtensions::AsValue(uPtr(uCast< ::g::Fuse::Scripting::V8::Array*>(obj, ::TYPES[15/*Fuse.Scripting.V8.Array*/]))->GetJSArray(pool));

    if (uIs(obj, ::TYPES[16/*Fuse.Scripting.V8.Function*/]))
        return ::g::Fuse::Scripting::V8::V8SimpleExtensions::AsValue2(uPtr(uCast< ::g::Fuse::Scripting::V8::Function*>(obj, ::TYPES[16/*Fuse.Scripting.V8.Function*/]))->GetJSFunction(pool));

    if (uIs(obj, ::TYPES[17/*Fuse.Scripting.Callback*/]))
        return ::g::Fuse::Scripting::V8::V8SimpleExtensions::AsValue2(::g::Fuse::Scripting::V8::V8SimpleExtensions::NewCallback(cxt, uDelegate::New(::TYPES[18/*Fuse.Scripting.V8.V8SimpleExtensions.WrappedCallback*/], (void*)Marshaller__CallbackWrapper__Call_fn, Marshaller__CallbackWrapper::New1(context, uCast<uDelegate*>(obj, ::TYPES[17/*Fuse.Scripting.Callback*/]))), pool, uPtr(context)->_errorHandler));

    if (uIs(obj, ::TYPES[7/*Fuse.Scripting.External*/]))
        return ::g::Fuse::Scripting::V8::V8SimpleExtensions::AsValue1(::g::Fuse::Scripting::V8::V8SimpleExtensions::NewExternal(cxt, ::g::Fuse::Scripting::V8::Handle::Create(uPtr(uCast< ::g::Fuse::Scripting::External*>(obj, ::TYPES[7/*Fuse.Scripting.External*/]))->Object), pool));

    U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[5/*"Unhandled t...*/], ::g::Uno::Object::GetType(uPtr(obj))), ::STRINGS[6/*":"*/]), obj)));
}
...
uArray* Marshaller::UnwrapArray(::g::Fuse::Scripting::V8::Context* context, uArray* values, ::g::Fuse::Scripting::V8::AutoReleasePool pool)
{
    ...
    uArray* unwrappedValues = uArray::New(::TYPES[19/*Fuse.Scripting.V8.Simple.JSValue[]*/], len);
...
uObject* Marshaller::Wrap(::g::Fuse::Scripting::V8::Context* context, ::JSValue* val)
{
    ...
    switch (::g::Fuse::Scripting::V8::V8SimpleExtensions::GetJSType(val))
    {
        ...
        case 2:
            return uBox(::TYPES[6/*double*/], ::g::Fuse::Scripting::V8::V8SimpleExtensions::AsDouble(val));
        case 3:
            return ::g::Fuse::Scripting::V8::V8SimpleExtensions::ToStr(::g::Fuse::Scripting::V8::V8SimpleExtensions::AsString(val), cxt);
        case 4:
            return uBox(::TYPES[12/*bool*/], ::g::Fuse::Scripting::V8::V8SimpleExtensions::AsBool(val));
        case 5:
        {
        ...
        default:
            U_THROW(::g::Uno::Exception::New2(::STRINGS[7/*"V8 marshall...*/]));
    }
}
...
uArray* Marshaller::WrapArray(::g::Fuse::Scripting::V8::Context* context, uArray* values)
{
    ...
    uArray* wrappedValues = uArray::New(::TYPES[20/*object[]*/], len);
...
{
    ::STRINGS[8] = uString::Const("No such method: ");
    ::TYPES[16] = ::g::Fuse::Scripting::V8::Function_typeof();
    ::TYPES[0] = ::g::Uno::IDisposable_typeof();
    ::TYPES[20] = uObject_typeof()->Array();
...
void Object__CallMethod_fn(Object* __this, uString* name, uArray* args, uObject** __retval)
{
...

    {
...

        {
            ...
            const uFinally<decltype(__finally_fun)> __f(__finally_fun);
            ::g::Fuse::Scripting::V8::Function* fun = uAs< ::g::Fuse::Scripting::V8::Function*>(::g::Fuse::Scripting::V8::Marshaller::Wrap(__this->_context, ::g::Fuse::Scripting::V8::V8SimpleExtensions::GetProperty1(__this->_object, cxt, name, pool, uPtr(__this->_context)->_errorHandler)), ::TYPES[16/*Fuse.Scripting.V8.Function*/]);

            if (fun == NULL)
                U_THROW(::g::Fuse::Scripting::Error::New4(::g::Uno::String::op_Addition1(::STRINGS[8/*"No such met...*/], fun)));
...
{
    ::g::Fuse::Scripting::V8::Function* f = uAs< ::g::Fuse::Scripting::V8::Function*>(type, ::TYPES[16/*Fuse.Scripting.V8.Function*/]);
    return *__retval = uUnbox<bool>(::TYPES[12/*bool*/], uPtr(uPtr(__this->_context)->_instanceOf)->Call(uArray::Init<uObject*>(::TYPES[20/*object[]*/], 2, __this, type))), void();
}
...
void Object__get_Keys_fn(Object* __this, uArray** __retval)
{
...

    {
...

        {
            ...
            result = uArray::New(::TYPES[21/*string[]*/], len);
            ...
            for (int i = 0; i < len; ++i)
            {
                ...
                uString* strProp = uAs<uString*>(wrappedProp, ::TYPES[10/*string*/]);
...
{
    V8SimpleExtensions::CilCallback_ = uDelegate::New(::TYPES[22/*Fuse.Scripting.V8.Simple.JSCallback*/], (void*)V8SimpleExtensions__CilCallbackImpl_fn);
}

static void V8SimpleExtensions_build(uType* type)
{
    ::TYPES[22] = ::g::Fuse::Scripting::V8::Simple::JSCallback_typeof();
    ::TYPES[18] = V8SimpleExtensions__WrappedCallback_typeof();
    type->SetFields(0,
        ::TYPES[22/*Fuse.Scripting.V8.Simple.JSCallback*/], (uintptr_t)&::g::Fuse::Scripting::V8::V8SimpleExtensions::CilCallback_, uFieldFlagsStatic);
}
...
::JSValue* V8SimpleExtensions::CilCallbackImpl(::JSContext* context, void* data, uArray* args, int numArgs, ::JSValue** error)
{
    V8SimpleExtensions_typeof()->Init();
    ::JSValue* ret1;
    uDelegate* wrappedCallback = uAs<uDelegate*>(::g::Fuse::Scripting::V8::Handle::Target(data), ::TYPES[18/*Fuse.Scripting.V8.V8SimpleExtensions.WrappedCallback*/]);
