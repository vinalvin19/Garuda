// This file was generated based on C:/Users/Lotus/AppData/Local/Fusetools/Packages/UnoCore/1.2.1/backends/cplusplus/Uno/_mainMobile.cpp.
...
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* garuda_accessor_Tab_Text_typeof();}
namespace g{uClassType* garuda_bundle_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* garuda_FuseControlsNavigationControl_Active_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* garuda_FuseControlsTextControl_Value_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* garuda_FuseElementsElement_ElementLayoutMaster_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* garuda_Tab_Text_Property_typeof();}
namespace g{namespace Fuse{struct AppBase_type;} ::g::Fuse::AppBase_type* MainView_typeof();}
namespace g{namespace Fuse{namespace Controls{struct TextControl_type;}} ::g::Fuse::Controls::TextControl_type* page1Text_typeof();}
namespace g{namespace Fuse{namespace Controls{struct TextControl_type;}} ::g::Fuse::Controls::TextControl_type* page1TextBawah_typeof();}
namespace g{namespace Fuse{namespace Controls{struct Control_type;}} ::g::Fuse::Controls::Control_type* PagePlaceholder_typeof();}
...
namespace g{namespace Fuse{namespace Scripting{uType* NativeEvent_typeof();}}}
namespace g{namespace Fuse{namespace Scripting{struct Module_type; ::g::Fuse::Scripting::Module_type* NativeEventEmitterModule_typeof();}}}
namespace g{namespace Fuse{namespace Scripting{uType* NativeFunction_typeof();}}}
namespace g{namespace Fuse{namespace Scripting{uType* NativeMember_typeof();}}}
namespace g{namespace Fuse{namespace Scripting{struct Module_type; ::g::Fuse::Scripting::Module_type* NativeModule_typeof();}}}
namespace g{namespace Fuse{namespace Scripting{uType* NativePromise_typeof();}}}
namespace g{namespace Fuse{namespace Scripting{uType* NativeProperty_typeof();}}}
...
namespace g{namespace Fuse{namespace Scripting{uType* ScriptMethod_typeof();}}}
namespace g{namespace Fuse{namespace Scripting{uType* ScriptMethod1_typeof();}}}
namespace g{namespace Fuse{namespace Scripting{uType* ScriptMethodInline_typeof();}}}
namespace g{namespace Fuse{namespace Scripting{struct Module_type; ::g::Fuse::Scripting::Module_type* ScriptModule_typeof();}}}
namespace g{namespace Fuse{namespace Scripting{uType* ScriptProperty_typeof();}}}
namespace g{namespace Fuse{namespace Scripting{uType* ScriptProperty1_typeof();}}}
...
namespace g{namespace Fuse{namespace Scripting{struct Module_type;}} namespace Fuse{namespace Reactive{namespace FuseJS{::g::Fuse::Scripting::Module_type* DiagnosticsImplModule_typeof();}}}}
namespace g{namespace Fuse{namespace Scripting{struct Module_type;}} namespace Fuse{namespace Reactive{namespace FuseJS{::g::Fuse::Scripting::Module_type* Http_typeof();}}}}
...
namespace g{namespace Fuse{namespace Scripting{struct Module_type;}} namespace Fuse{namespace Reactive{namespace FuseJS{::g::Fuse::Scripting::Module_type* TimerModule_typeof();}}}}
...
namespace g{namespace Fuse{namespace Scripting{struct Module_type;}} namespace Fuse{namespace Triggers{::g::Fuse::Scripting::Module_type* BusyTaskModule_typeof();}}}
...
namespace g{namespace Fuse{namespace Gestures{uType* ClickedArgs_typeof();}}}
...
namespace g{namespace Fuse{namespace Scripting{struct Module_type;}} namespace Fuse{namespace FileSystem{::g::Fuse::Scripting::Module_type* FileSystemModule_typeof();}}}
...
namespace g{namespace Fuse{namespace Scripting{struct Module_type;}} namespace Fuse{namespace Storage{::g::Fuse::Scripting::Module_type* StorageModule_typeof();}}}
...
namespace g{namespace Fuse{namespace Scripting{struct Module_type;}} namespace Fuse{namespace Testing{::g::Fuse::Scripting::Module_type* UnoTestingHelper_typeof();}}}
namespace g{namespace Fuse{namespace Scripting{struct Module_type;}} namespace Fuse{namespace WebSocket{::g::Fuse::Scripting::Module_type* NativeFunctionModule_typeof();}}}
namespace g{namespace Fuse{namespace Scripting{struct Module_type;}} namespace Fuse{namespace WebSocket{::g::Fuse::Scripting::Module_type* WebSocketClientModule_typeof();}}}
...
namespace g{namespace Fuse{namespace Scripting{struct Module_type;}} namespace Polyfills{namespace Window{::g::Fuse::Scripting::Module_type* WindowModule_typeof();}}}
namespace g{namespace Fuse{namespace Scripting{struct Module_type;}} namespace FuseJS{::g::Fuse::Scripting::Module_type* Base64_typeof();}}
namespace g{namespace Fuse{namespace Scripting{struct Module_type;}} namespace FuseJS{::g::Fuse::Scripting::Module_type* Bundle_typeof();}}
namespace g{namespace Fuse{namespace Scripting{struct Module_type;}} namespace FuseJS{::g::Fuse::Scripting::Module_type* Environment_typeof();}}
...
namespace g{namespace Fuse{namespace Scripting{struct Module_type;}} namespace FuseJS{::g::Fuse::Scripting::Module_type* FileReaderImpl_typeof();}}
namespace g{namespace Fuse{namespace Scripting{struct Module_type;}} namespace FuseJS{::g::Fuse::Scripting::Module_type* Globals_typeof();}}
namespace g{namespace FuseJS{uClassType* Latin1Helpers_typeof();}}
namespace g{namespace Fuse{namespace Scripting{struct Module_type;}} namespace FuseJS{::g::Fuse::Scripting::Module_type* Lifecycle_typeof();}}
...
namespace g{namespace Fuse{namespace Scripting{struct Module_type;}} namespace FuseJS{::g::Fuse::Scripting::Module_type* UserEvents_typeof();}}
...
void uInitRtti()
{
    static uType*(*factories[])() =
    {
        ...
        (uType*(*)())&::g::garuda_accessor_Tab_Text_typeof,
        (uType*(*)())&::g::garuda_bundle_typeof,
        (uType*(*)())&::g::garuda_FuseControlsNavigationControl_Active_Property_typeof,
        (uType*(*)())&::g::garuda_FuseControlsTextControl_Value_Property_typeof,
        (uType*(*)())&::g::garuda_FuseElementsElement_ElementLayoutMaster_Property_typeof,
        (uType*(*)())&::g::garuda_Tab_Text_Property_typeof,
        (uType*(*)())&::g::MainView_typeof,
        (uType*(*)())&::g::page1Text_typeof,
        (uType*(*)())&::g::page1TextBawah_typeof,
