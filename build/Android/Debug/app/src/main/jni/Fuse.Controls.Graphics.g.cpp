...
// C:\Users\Lotus\AppData\Local\Fusetools\Packages\Fuse.Controls\1.2.0\graphics\$.uno
// ----------------------------------------------------------------------------------
...
static void ControlVisual_build(uType* type)
{
    ...
    type->SetInterfaces(
        ...
        ::g::Fuse::ITemplateSource_typeof(), offsetof(ControlVisual_type, interface6),
        ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL), offsetof(ControlVisual_type, interface7),
        ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL), offsetof(ControlVisual_type, interface8));
    type->SetFields(61,
...
static void Visual_build(uType* type)
{
    type->SetInterfaces(
        ...
        ::g::Fuse::ITemplateSource_typeof(), offsetof(::g::Fuse::Visual_type, interface6),
        ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL), offsetof(::g::Fuse::Visual_type, interface7),
        ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL), offsetof(::g::Fuse::Visual_type, interface8));
    type->SetFields(59,
