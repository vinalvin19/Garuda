...
// C:\Users\Lotus\AppData\Local\Fusetools\Packages\Fuse.Elements\1.2.0\resources\$.uno
// -----------------------------------------------------------------------------------
...
static void ImageSource_build(uType* type)
{
    ...
    ::STRINGS[13] = uString::Const("C:\\Users\\Lotus\\AppData\\Local\\Fusetools\\Packages\\Fuse.Elements\\1.2.0\\resources\\$.uno");
...
{
    ::g::Fuse::Diagnostics::UnknownException(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[11/*"ImageSource...*/], msg), ::STRINGS[12/*"'"*/]), e, this, ::STRINGS[13/*"C:\\Users\\...*/], 620, ::STRINGS[14/*"OnError"*/]);
...
{
    ::STRINGS[15] = uString::Const("value-cannot-be-null");
    type->SetInterfaces(
...
{
    if (value == NULL)
        U_THROW(::g::Uno::Exception::New2(::STRINGS[15/*"value-canno...*/]));
...
{
    ::TYPES[20] = ::g::Uno::Collections::ObservableList_typeof()->MakeType(::g::Fuse::Resources::ImageSource_typeof(), NULL);
    ::TYPES[21] = ::g::Uno::Action1_typeof()->MakeType(::g::Fuse::Resources::ImageSource_typeof(), NULL);
    ...
    type->SetFields(4,
        ...
        ::TYPES[20/*Uno.Collections.ObservableList<Fuse.Resources.ImageSource>*/], offsetof(::g::Fuse::Resources::MultiDensityImageSource, _sources), 0);
}
...
{
    ctor_1();
    _sources = ((::g::Uno::Collections::ObservableList*)::g::Uno::Collections::ObservableList::New1(::TYPES[20/*Uno.Collections.ObservableList<Fuse.Resources.ImageSource>*/], uDelegate::New(::TYPES[21/*Uno.Action<Fuse.Resources.ImageSource>*/], (void*)MultiDensityImageSource__OnImageAdded_fn, this), uDelegate::New(::TYPES[21/*Uno.Action<Fuse.Resources.ImageSource>*/], (void*)MultiDensityImageSource__OnImageRemoved_fn, this)));
    _proxy = ::g::Fuse::Resources::ProxyImageSource::New1(this);
}
...
void MultiDensityImageSource::SelectActive()
{
    ...
    for (uObject* enum1 = (uObject*)uPtr(_sources)->GetEnumerator(); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum1), ::TYPES[22/*Uno.Collections.IEnumerator*/])); )
    {
        ::g::Fuse::Resources::ImageSource* source = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum1), ::TYPES[23/*Uno.Collections.IEnumerator<Fuse.Resources.ImageSource>*/]), &ret3), ret3);
...
{
    ::TYPES[26] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::String_typeof(), ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Action_typeof(), NULL), NULL);
    ::TYPES[27] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Action_typeof(), NULL);
    ::TYPES[28] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Uno::Action_typeof(), NULL);
    type->SetFields(0,
        ::TYPES[26/*Uno.Collections.Dictionary<string, Uno.Collections.List<Uno.Action>>*/], (uintptr_t)&::g::Fuse::Resources::ResourceRegistry::_handlers_, uFieldFlagsStatic);
}
