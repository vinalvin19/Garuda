...
static void ImageContainer_build(uType* type)
{
    ...
    ::STRINGS[2] = uString::Const("C:\\Users\\Lotus\\AppData\\Local\\Fusetools\\Packages\\Fuse.Elements\\1.2.0\\internal\\$.uno");
...
void ImageContainer::ResampleMode(int value)
{
    ...
    {
        if (value == 2)
            ::g::Fuse::Diagnostics::Deprecated(::STRINGS[4/*"ResampleMod...*/], this, ::STRINGS[2/*"C:\\Users\\...*/], 295, ::STRINGS[5/*"set_Resampl...*/]);
...
void ImageContainer::UpdateSourceListen(bool forceOff)
{
    ...
    if (_source == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[1/*"Switching l...*/], this, ::STRINGS[2/*"C:\\Users\\...*/], 179, ::STRINGS[3/*"UpdateSourc...*/]);
