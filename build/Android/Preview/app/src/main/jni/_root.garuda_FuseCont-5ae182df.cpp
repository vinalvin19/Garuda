...
{
    uStackFrame __("garuda_FuseControlsNavigationControl_Active_Property", "Get(Uno.UX.PropertyObject)");
...
{
    uStackFrame __("garuda_FuseControlsNavigationControl_Active_Property", "Set(Uno.UX.PropertyObject,Fuse.Visual,Uno.UX.IPropertyListener)");
