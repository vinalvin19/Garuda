...
// C:\Users\Lotus\AppData\Local\Fusetools\Packages\UnoCore\1.2.1\source\uno\content\fonts\$.uno
// --------------------------------------------------------------------------------------------
...
static void DefaultTextTransform_build(uType* type)
{
    ...
    ::STRINGS[2] = uString::Const("C:/Users/Lotus/AppData/Local/Fusetools/Packages/UnoCore/1.2.1/source/uno/content/fonts/$.uno");
    type->SetFields(0,
...
{
    ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[1/*"DefaultText...*/], 0, ::STRINGS[2/*"C:/Users/Lo...*/], 321);
    return *__retval = __this->_matrix, void();
}
