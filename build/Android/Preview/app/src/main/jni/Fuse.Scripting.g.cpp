...
static void NativeEvent_build(uType* type)
{
    ...
    ::STRINGS[30] = uString::Const("C:/Users/Lotus/AppData/Local/Fusetools/Packages/Fuse.Scripting/1.2.0/$.uno");
...
uObject* NativeEvent::RaiseSync(uArray* args)
{
    ...
    ::g::Uno::Diagnostics::Debug::Assert(Context() != NULL, ::STRINGS[29/*"this.Contex...*/], ::STRINGS[30/*"C:/Users/Lo...*/], 899, uArray::New(::TYPES[9/*object[]*/], 0));
...
static void ScriptModule__RequireContext_build(uType* type)
{
    ...
    ::STRINGS[40] = uString::Const("C:\\Users\\Lotus\\AppData\\Local\\Fusetools\\Packages\\Fuse.Scripting\\1.2.0\\$.uno");
    ::STRINGS[41] = uString::Const("Require");
    ::STRINGS[42] = uString::Const(" line ");
...
uObject* ScriptModule__RequireContext::Require1(uString* id)
{
    ...
    if (module == NULL)
    {
        ...
        if (module->Error() == NULL)
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserSuccess(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[38/*"JavaScript ...*/], path), ::STRINGS[39/*" was fixed!"*/]), this, ::STRINGS[40/*"C:\\Users\\...*/], 1879, ::STRINGS[41/*"Require"*/]);
        ...
        else
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[38/*"JavaScript ...*/], path), ::STRINGS[42/*" line "*/]), uBox<int>(::TYPES[47/*int*/], uPtr(e)->LineNumber())), ::STRINGS[43/*". "*/]), uPtr(e)->ErrorMessage()), this, ::STRINGS[40/*"C:\\Users\\...*/], 1889, ::STRINGS[41/*"Require"*/], NULL);
...
{
    ::STRINGS[44] = uString::Const("Name: ");
    ::STRINGS[45] = uString::Const("Error message: ");
    ::STRINGS[46] = uString::Const("File name: ");
    ::STRINGS[47] = uString::Const("Line number: ");
    ::STRINGS[48] = uString::Const("Source line: ");
    ::STRINGS[49] = uString::Const("JS stack trace: ");
    ::TYPES[47] = ::g::Uno::Int_typeof();
    type->SetFields(4,
...
void ScriptException__get_Message_fn(ScriptException* __this, uString** __retval)
{
    ...
    {
        uPtr(stringBuilder)->Append2(::STRINGS[44/*"Name: "*/]);
        stringBuilder->AppendLine(__this->Name());
    }

    if (!::g::Uno::String::IsNullOrEmpty(__this->ErrorMessage()))
    {
        uPtr(stringBuilder)->Append2(::STRINGS[45/*"Error messa...*/]);
    ...
    {
        uPtr(stringBuilder)->Append2(::STRINGS[48/*"Source line: "*/]);
        stringBuilder->AppendLine(__this->SourceLine());
    }

    if (!::g::Uno::String::IsNullOrEmpty(__this->JSStackTrace()))
    {
        uPtr(stringBuilder)->Append2(::STRINGS[49/*"JS stack tr...*/]);
...
{
    ::STRINGS[50] = uString::Const("Cannot call a non-void method asynchronously");
    ::STRINGS[40] = uString::Const("C:\\Users\\Lotus\\AppData\\Local\\Fusetools\\Packages\\Fuse.Scripting\\1.2.0\\$.uno");
    ::STRINGS[51] = uString::Const("Call");
    ::TYPES[3] = ::g::Uno::Action_typeof();
...
void ScriptMethod1__Call_fn(ScriptMethod1* __this, ::g::Fuse::Scripting::Context* c, uObject* obj, uArray* args, uObject** __retval)
{
    ...
    if (__this->Thread == 2)
    {
        ...
        {
            ::g::Fuse::Diagnostics::InternalError(::STRINGS[50/*"Cannot call...*/], __this, ::STRINGS[40/*"C:\\Users\\...*/], 1582, ::STRINGS[51/*"Call"*/]);
            return *__retval = NULL, void();
        }
...
{
    ScriptModule::ModuleContainsAnErrorMessage_ = ::STRINGS[52/*"require(): ...*/];
}

static void ScriptModule_build(uType* type)
{
    ::STRINGS[52] = uString::Const("require(): module contains an error: ");
    ::STRINGS[53] = uString::Const(".js");
    ::STRINGS[11] = uString::Const("");
    ::STRINGS[54] = uString::Const(".");
    ::STRINGS[55] = uString::Const("/");
    ::STRINGS[56] = uString::Const("..");
    ::STRINGS[57] = uString::Const("(function(");
    ::STRINGS[58] = uString::Const(") { ");
    ::STRINGS[59] = uString::Const("\n"
        " })");
    ::STRINGS[60] = uString::Const("Could not evaluate module '");
    ::STRINGS[61] = uString::Const("': JavaScript code contains errors");
    ::STRINGS[25] = uString::Const("exports");
    ::STRINGS[62] = uString::Const("module, exports, require");
    ::STRINGS[63] = uString::Const("/index.js");
...
void ScriptModule__Evaluate_fn(ScriptModule* __this, ::g::Fuse::Scripting::Context* c, ::g::Fuse::Scripting::ModuleResult* result)
{
    ...
    uString* wrappedCode = ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[57/*"(function("*/], __this->GenerateArgs(c, result, args)), ::STRINGS[58/*") { "*/]), uString::CharArray(newlines)), __this->GetEffectiveCode()), ::STRINGS[59/*"\n })"*/]);
    ...
    if (moduleFunc == NULL)
        U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[60/*"Could not e...*/], __this->FileName()), ::STRINGS[61/*"': JavaScri...*/])));
...
void ScriptModule__GenerateArgs_fn(ScriptModule* __this, ::g::Fuse::Scripting::Context* c, ::g::Fuse::Scripting::ModuleResult* result, ::g::Uno::Collections::List* args, uString** __retval)
{
    ...
    return *__retval = ::STRINGS[62/*"module, exp...*/], void();
}
...
uString* ScriptModule::ComputePath(uString* moduleId, bool* isFile)
{
    ...
    if (::g::Uno::String::EndsWith(uPtr(moduleId), ::STRINGS[53/*".js"*/]))
        moduleId = ::g::Uno::String::Replace1(uPtr(moduleId), ::STRINGS[53/*".js"*/], ::STRINGS[11/*""*/]);

    if (::g::Uno::String::StartsWith(uPtr(moduleId), ::STRINGS[54/*"."*/]))
    {
        *isFile = true;
        return ScriptModule::ComputePath1(GetSourcePath(), moduleId);
    }
    else if (::g::Uno::String::StartsWith(uPtr(moduleId), ::STRINGS[55/*"/"*/]))
    {
        *isFile = true;
...
uString* ScriptModule::ComputePath1(uString* sourcePath, uString* moduleId)
{
    ...
    for (int i = 0; i < uPtr(parts)->Length(); i++)
        if (::g::Uno::String::op_Equality(uPtr(parts)->Strong<uString*>(i), ::STRINGS[11/*""*/]))
            continue;
        else if (::g::Uno::String::op_Equality(uPtr(parts)->Strong<uString*>(i), ::STRINGS[54/*"."*/]))
            continue;
        else if (::g::Uno::String::op_Equality(uPtr(parts)->Strong<uString*>(i), ::STRINGS[56/*".."*/]))
            sourcePath = ::g::Uno::String::Replace(uPtr(::g::Uno::IO::Path::GetDirectoryName(sourcePath)), '\\', '/');
        else if (uPtr(sourcePath)->Length() > 0)
            sourcePath = ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(sourcePath, ::STRINGS[55/*"/"*/]), uPtr(parts)->Strong<uString*>(i));
        else
...
bool ScriptModule::IsPathEqual(uString* src, uString* path)
{
    ...
    if (::g::Uno::String::op_Equality(src, ::g::Uno::String::op_Addition2(path, ::STRINGS[53/*".js"*/])))
        return true;

    if (::g::Uno::String::op_Equality(src, ::g::Uno::String::op_Addition2(path, ::STRINGS[63/*"/index.js"*/])))
        return true;
...
{
    ::STRINGS[64] = uString::Const("ScriptProperty: incorrect owner type");
    type->SetPrecalc(
        type->T(0));
    type->SetFields(2,
...
void ScriptProperty1__GetProperty_fn(ScriptProperty1* __this, ::g::Uno::UX::PropertyObject* owner, ::g::Uno::UX::Property** __retval)
{
    ...
    if (!uIs(owner, __types[0]))
        U_THROW(::g::Uno::Exception::New2(::STRINGS[64/*"ScriptPrope...*/]));
