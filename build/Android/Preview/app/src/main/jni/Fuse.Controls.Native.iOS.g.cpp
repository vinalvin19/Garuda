...
// public Slider(Fuse.Controls.Native.IRangeViewHost host, Fuse.Visual visual) :1977
void Slider__ctor__fn(Slider* __this, uObject* host, ::g::Fuse::Visual* visual)
{
    __this->ctor_(host, visual);
}

// public Slider New(Fuse.Controls.Native.IRangeViewHost host, Fuse.Visual visual) :1977
void Slider__New1_fn(uObject* host, ::g::Fuse::Visual* visual, Slider** __retval)
{
    *__retval = Slider::New1(host, visual);
}

// public void set_Progress(double value) :1974
void Slider__set_Progress_fn(Slider* __this, double* value)
{
    __this->Progress(*value);
}

// public Slider(Fuse.Controls.Native.IRangeViewHost host, Fuse.Visual visual) [instance] :1977
void Slider::ctor_(uObject* host, ::g::Fuse::Visual* visual)
{
}

// public void set_Progress(double value) [instance] :1974
void Slider::Progress(double value)
{
}

// public Slider New(Fuse.Controls.Native.IRangeViewHost host, Fuse.Visual visual) [static] :1977
...
// public sealed extern class Switch :2059
// {
...
// public Switch(Fuse.Controls.Native.IToggleViewHost host) :2065
void Switch__ctor__fn(Switch* __this, uObject* host)
{
    __this->ctor_(host);
}

// public void set_Host(Fuse.Controls.Native.IToggleViewHost value) :2062
void Switch__set_Host_fn(Switch* __this, uObject* value)
{
    __this->Host(value);
}

// public Switch New(Fuse.Controls.Native.IToggleViewHost host) :2065
void Switch__New1_fn(uObject* host, Switch** __retval)
{
    *__retval = Switch::New1(host);
}

// public void set_Value(bool value) :2061
void Switch__set_Value_fn(Switch* __this, bool* value)
{
    __this->Value(*value);
}

// public Switch(Fuse.Controls.Native.IToggleViewHost host) [instance] :2065
void Switch::ctor_(uObject* host)
{
}

// public void set_Host(Fuse.Controls.Native.IToggleViewHost value) [instance] :2062
void Switch::Host(uObject* value)
{
}

// public void set_Value(bool value) [instance] :2061
void Switch::Value(bool value)
{
}

// public Switch New(Fuse.Controls.Native.IToggleViewHost host) [static] :2065
