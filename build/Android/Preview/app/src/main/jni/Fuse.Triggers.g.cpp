...
static void Busy_build(uType* type)
{
    ...
    ::STRINGS[3] = uString::Const("C:\\Users\\Lotus\\AppData\\Local\\Fusetools\\Packages\\Fuse.Triggers\\1.2.0\\$.uno");
...
void Busy::UpdateState()
{
    ...
    if ((_rootOn & 1) == 1)
    {
        ...
        {
            _rootOn = (_rootOn & -2);
            ::g::Fuse::Diagnostics::UserError(::STRINGS[6/*"On='Paramet...*/], this, ::STRINGS[3/*"C:\\Users\\...*/], 203, ::STRINGS[7/*"UpdateState"*/], NULL);
        }
        else
...
void Busy::activate(::g::Fuse::Scripting::Context* c, Busy* b, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[2/*"Busy.activa...*/], b, ::STRINGS[3/*"C:\\Users\\...*/], 264, ::STRINGS[0/*"activate"*/], NULL);
        return;
    }
...
void Busy::deactivate(::g::Fuse::Scripting::Context* c, Busy* b, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[4/*"Busy.deacti...*/], b, ::STRINGS[3/*"C:\\Users\\...*/], 282, ::STRINGS[1/*"deactivate"*/], NULL);
        return;
    }
...
void Completed::reset(::g::Fuse::Scripting::Context* c, Completed* cp, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[11/*"Completed.r...*/], cp, ::STRINGS[3/*"C:\\Users\\...*/], 824, ::STRINGS[10/*"reset"*/], NULL);
        return;
    }
...
uObject* BusyTaskModule__ConstructorClosure::Construct(uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::Deprecated(::STRINGS[12/*"Use the `Bu...*/], this, ::STRINGS[3/*"C:\\Users\\...*/], 580, ::STRINGS[13/*"Construct"*/]);
...
// C:\Users\Lotus\AppData\Local\Fusetools\Packages\Fuse.Controls.Primitives\1.2.0\triggers\$.uno
// ---------------------------------------------------------------------------------------------
...
static void ContainingText_build(uType* type)
{
    ...
    ::STRINGS[17] = uString::Const("C:\\Users\\Lotus\\AppData\\Local\\Fusetools\\Packages\\Fuse.Controls.Primitives\\1.2.0\\triggers\\$.uno");
...
// C:\Users\Lotus\AppData\Local\Fusetools\Packages\Fuse.Controls\1.2.0\triggers\$.uno
// ----------------------------------------------------------------------------------
...
static void LayoutAnimation_build(uType* type)
{
    ...
    ::STRINGS[20] = uString::Const("C:\\Users\\Lotus\\AppData\\Local\\Fusetools\\Packages\\Fuse.Elements\\1.2.0\\triggers\\$.uno");
...
void LayoutAnimation__OnRooted_fn(LayoutAnimation* __this)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[19/*"LayoutAnima...*/], __this, ::STRINGS[20/*"C:\\Users\\...*/], 229, ::STRINGS[21/*"OnRooted"*/], NULL);
        return;
    }
...
static void OnUserEvent_build(uType* type)
{
    ...
    ::STRINGS[23] = uString::Const("C:\\Users\\Lotus\\AppData\\Local\\Fusetools\\Packages\\Fuse.UserEvents\\1.2.0\\$.uno");
    ::STRINGS[21] = uString::Const("OnRooted");
...
void OnUserEvent__OnRooted_fn(OnUserEvent* __this)
{
    ...
    if (::g::Uno::String::op_Equality(::g::Uno::UX::Selector__op_Implicit1(__this->EventName()), NULL))
        ::g::Fuse::Diagnostics::UserError(::STRINGS[22/*"OnUserEvent...*/], __this, ::STRINGS[23/*"C:\\Users\\...*/], 99, ::STRINGS[21/*"OnRooted"*/], NULL);
    else
    {
...
static void PageBeginLoading_build(uType* type)
{
    ...
    ::STRINGS[25] = uString::Const("C:\\Users\\Lotus\\AppData\\Local\\Fusetools\\Packages\\Fuse.Controls.WebView\\1.2.0\\$.uno");
    ::STRINGS[21] = uString::Const("OnRooted");
...
void PageBeginLoading__OnRooted_fn(PageBeginLoading* __this)
{
    ...
    if (uIs((::g::Fuse::Visual*)__this->Parent(), ::TYPES[31/*Fuse.Controls.IWebView*/]))
    {
        ...
        ::g::Fuse::Diagnostics::UserRootError(::STRINGS[24/*"WebView"*/], __this->Parent(), __this, ::STRINGS[25/*"C:\\Users\\...*/], 1083, ::STRINGS[21/*"OnRooted"*/]);
}
...
void PageLoaded__OnRooted_fn(PageLoaded* __this)
{
    ...
    if (uIs((::g::Fuse::Visual*)__this->Parent(), ::TYPES[31/*Fuse.Controls.IWebView*/]))
    {
        ...
        ::g::Fuse::Diagnostics::UserRootError(::STRINGS[24/*"WebView"*/], __this->Parent(), __this, ::STRINGS[25/*"C:\\Users\\...*/], 1142, ::STRINGS[21/*"OnRooted"*/]);
}
...
void RemovingAnimation__FuseIBeginRemoveVisualListenerOnBeginRemoveVisual_fn(RemovingAnimation* __this, ::g::Fuse::PendingRemoveVisual* pr)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[26/*"Double remo...*/], __this, ::STRINGS[3/*"C:\\Users\\...*/], 1742, ::STRINGS[27/*"Fuse.IBegin...*/]);
        return;
    }
...
void RemovingAnimation::OnDone()
{
    ...
    if (_args == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[28/*"Unexpected ...*/], this, ::STRINGS[3/*"C:\\Users\\...*/], 1755, ::STRINGS[29/*"OnDone"*/]);
        return;
    }
...
static void Scrolled_build(uType* type)
{
    ...
    ::STRINGS[32] = uString::Const("C:\\Users\\Lotus\\AppData\\Local\\Fusetools\\Packages\\Fuse.Controls.ScrollView\\1.2.0\\triggers\\$.uno");
...
void Scrolled__OnRooted_fn(Scrolled* __this)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[33/*"Scrolled co...*/], __this, ::STRINGS[32/*"C:\\Users\\...*/], 288, ::STRINGS[21/*"OnRooted"*/], NULL);
        return;
    }
...
void Scrolled::check(::g::Fuse::Scripting::Context* c, Scrolled* s, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[31/*"check takes...*/], s, ::STRINGS[32/*"C:\\Users\\...*/], 242, ::STRINGS[30/*"check"*/], NULL);
        return;
    }
...
// protected override void OnRooted() :516
...
// protected override void OnUnrooted() :529
...
// private void Uno.UX.IPropertyListener.OnPropertyChanged(Uno.UX.PropertyObject obj, Uno.UX.Selector prop) :541
...
// public generated ScrollRegion() :715
...
// public bool SetRelativeTo(Fuse.Triggers.IScrolledLength value) [instance] :736
...
// public bool SetTo(Fuse.Triggers.ScrolledWhere value) [instance] :718
...
// public bool SetWithin(float value) [instance] :727
...
// public generated ScrollRegion New() [static] :715
...
void State::Goto()
{
    ...
    if (_stateGroup == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[36/*"Cannot call...*/], NULL, ::STRINGS[3/*"C:\\Users\\...*/], 2110, ::STRINGS[37/*"Goto"*/]);
        return;
    }
...
void StateGroup::goto_(::g::Fuse::Scripting::Context* c, StateGroup* n, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[39/*"StateGroup....*/], n, ::STRINGS[3/*"C:\\Users\\...*/], 1825, ::STRINGS[40/*"goto_"*/], NULL);
        return;
    }
...
void StateGroup::gotoName(::g::Fuse::Scripting::Context* c, StateGroup* n, uString* name)
{
    ...
    if (state == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::STRINGS[41/*"Unable to f...*/], name), n, ::STRINGS[3/*"C:\\Users\\...*/], 1805, ::STRINGS[42/*"gotoName"*/], NULL);
        return;
    }
...
void TextInputActionTriggered__OnRooted_fn(TextInputActionTriggered* __this)
{
    ...
    if (__this->_textEdit == NULL)
        ::g::Fuse::Diagnostics::UserError(::STRINGS[43/*"TextInputAc...*/], __this, ::STRINGS[17/*"C:\\Users\\...*/], 126, ::STRINGS[21/*"OnRooted"*/], NULL);
    else
...
void Timeline::playTo(::g::Fuse::Scripting::Context* c, Timeline* n, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[54/*"Timeline.se...*/], n, ::STRINGS[3/*"C:\\Users\\...*/], 2536, ::STRINGS[50/*"playTo"*/], NULL);
        return;
    }
...
void Timeline::seek(::g::Fuse::Scripting::Context* c, Timeline* n, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[54/*"Timeline.se...*/], n, ::STRINGS[3/*"C:\\Users\\...*/], 2585, ::STRINGS[52/*"seek"*/], NULL);
        return;
    }
...
static void TransitionGroup_build(uType* type)
{
    ...
    ::STRINGS[57] = uString::Const("C:\\Users\\Lotus\\AppData\\Local\\Fusetools\\Packages\\Fuse.Controls.Navigation\\1.2.0\\$.uno");
...
TransitionGroup* TransitionGroup::Root(::g::Fuse::Triggers::Transition* t)
{
    ...
    if (nav == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[56/*"Transition ...*/], t, ::STRINGS[57/*"C:\\Users\\...*/], 2782, ::STRINGS[58/*"Root"*/], NULL);
        return NULL;
    }
    ...
    if (vis == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[59/*"Transition ...*/], t, ::STRINGS[57/*"C:\\Users\\...*/], 2789, ::STRINGS[58/*"Root"*/], NULL);
        return NULL;
    }
...
void Trigger__FuseAnimationsIBasePlayerFeedbackOnPlaybackDone_fn(Trigger* __this, uObject* s)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[60/*"Trigger.OnP...*/], __this, ::STRINGS[3/*"C:\\Users\\...*/], 2879, ::STRINGS[61/*"Fuse.Animat...*/]);
        return;
    }
...
void WhileContainsText__OnRooted_fn(WhileContainsText* __this)
{
    ...
    if (__this->_value != NULL)
    {
        ...
        ::g::Fuse::Diagnostics::UserError(::STRINGS[63/*"No TextInpu...*/], __this, ::STRINGS[17/*"C:\\Users\\...*/], 51, ::STRINGS[21/*"OnRooted"*/], NULL);
}
...
void WhilePageLoading__OnRooted_fn(WhilePageLoading* __this)
{
    ...
    if (uIs((::g::Fuse::Visual*)__this->Parent(), ::TYPES[31/*Fuse.Controls.IWebView*/]))
    {
        ...
        ::g::Fuse::Diagnostics::UserRootError(::STRINGS[24/*"WebView"*/], __this->Parent(), __this, ::STRINGS[25/*"C:\\Users\\...*/], 861, ::STRINGS[21/*"OnRooted"*/]);
}
...
// public sealed class WhileScrolled :793
// {
...
void WhileScrolled__OnRooted_fn(WhileScrolled* __this)
{
    ...
    if (__this->_scrollable == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[33/*"Scrolled co...*/], __this, ::STRINGS[32/*"C:\\Users\\...*/], 803, ::STRINGS[21/*"OnRooted"*/], NULL);
        return;
    }
...
// private void OnScrollPositionChanged(object s, object args) :827
void WhileScrolled__OnScrollPositionChanged_fn(WhileScrolled* __this, uObject* s, uObject* args)
{
    __this->OnScrollPositionChanged(s, args);
}

// protected override sealed void OnUnrooted() :817
...
// private void OnScrollPositionChanged(object s, object args) [instance] :827
...
// public Fuse.Triggers.IScrolledLength get_RelativeTo() [instance] :851
...
// public void set_RelativeTo(Fuse.Triggers.IScrolledLength value) [instance] :852
...
// public Fuse.Triggers.ScrolledWhere get_To() [instance] :837
...
// public void set_To(Fuse.Triggers.ScrolledWhere value) [instance] :838
...
// private void Update() [instance] :811
...
// public float get_Within() [instance] :844
...
// public void set_Within(float value) [instance] :845
...
// public generated WhileScrolled New() [static] :793
...
void WhileValue::Pulse1()
{
    ...
    {
        ::g::Fuse::Diagnostics::Deprecated(::STRINGS[64/*"`Pulse` on ...*/], this, ::STRINGS[3/*"C:\\Users\\...*/], 4249, ::STRINGS[65/*"Pulse"*/]);
...
static void WhileVisibleInScrollView_build(uType* type)
{
    ...
    type->SetFields(34,
        ...
        ::g::Fuse::Triggers::WhileVisibleInScrollViewMode_typeof(), offsetof(::g::Fuse::Triggers::WhileVisibleInScrollView, _mode), 0,
...
void WhileVisibleInScrollView__OnRooted_fn(WhileVisibleInScrollView* __this)
{
    ...
    if (__this->_scrollable == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[66/*"Could not f...*/], __this, ::STRINGS[32/*"C:\\Users\\...*/], 923, ::STRINGS[21/*"OnRooted"*/], NULL);
        return;
    }
    ...
    if (__this->_element == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[67/*"Parent must...*/], __this, ::STRINGS[32/*"C:\\Users\\...*/], 930, ::STRINGS[21/*"OnRooted"*/], NULL);
        return;
    }

    if (!uPtr(__this->_element)->HasLayoutIn(__this->_scrollable))
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[68/*"Must have a...*/], __this, ::STRINGS[32/*"C:\\Users\\...*/], 936, ::STRINGS[21/*"OnRooted"*/], NULL);
        return;
    }
...
// public float get_Distance() [instance] :964
float WhileVisibleInScrollView::Distance()
{
    return _distance;
}

// public void set_Distance(float value) [instance] :965
...
// public Fuse.Triggers.WhileVisibleInScrollViewMode get_Mode() [instance] :1000
int WhileVisibleInScrollView::Mode()
{
    return _mode;
}

// public void set_Mode(Fuse.Triggers.WhileVisibleInScrollViewMode value) [instance] :1001
...
// private void OnScrollPositionChanged(object s, object args) [instance] :1008
...
// public Fuse.Triggers.IScrolledLength get_RelativeTo() [instance] :982
uObject* WhileVisibleInScrollView::RelativeTo()
{
    return _relativeTo;
}

// public void set_RelativeTo(Fuse.Triggers.IScrolledLength value) [instance] :983
...
// private void Update() [instance] :1013
...
// public generated WhileVisibleInScrollView New() [static] :912
...
// public enum WhileVisibleInScrollViewMode :871
