...
// C:\Users\Lotus\AppData\Local\Fusetools\Packages\Uno.Net.Http\1.2.1\uriparsers\$.uno
// -----------------------------------------------------------------------------------
...
static void HttpMessageCache_build(uType* type)
{
    ...
    ::STRINGS[23] = uString::Const("C:/Users/Lotus/AppData/Local/Fusetools/Packages/Uno.Net.Http/1.2.1/$.uno");
...
void HttpMessageCache::IsCacheEnabled(bool value)
{
    ...
    if (HttpMessageCache::_isInitialized())
        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[22/*"Uno.Net.Htt...*/], 0, ::STRINGS[23/*"C:/Users/Lo...*/], 17);
    else
