...
// C:\Users\Lotus\AppData\Local\Fusetools\Packages\Fuse.FileSystem\1.2.0\$.uno
// ---------------------------------------------------------------------------
...
// C:\Users\Lotus\AppData\Local\Fusetools\Packages\Fuse.FileSystem\1.2.0\uno\io\$.uno
// ----------------------------------------------------------------------------------
...
static void FileSystemModule_build(uType* type)
{
    ...
    ::TYPES[27] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(10/*ToArray<object>*/, uObject_typeof(), NULL);
    ...
    type->MethodTypes[1]->SetPrecalc(
        ::TYPES[28/*Uno.Collections.EnumerableExtensions*/]->MakeMethod(6/*OfType<T, object>*/, type->MethodTypes[1]->U(0), uObject_typeof(), NULL),
...
static void FileSystemOperations_build(uType* type)
{
    ...
    ::TYPES[47] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(10/*ToArray<string>*/, ::g::Uno::String_typeof(), NULL);
    ::TYPES[48] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(8/*Select<string, string>*/, ::g::Uno::String_typeof(), ::g::Uno::String_typeof(), NULL);
...
// public FileSystemOperations New(Uno.Threading.IDispatcher dispatcher) :1061
...
// public FileSystemOperations New(Uno.Threading.IDispatcher dispatcher) [static] :1061
...
// private Nothing() :1408
void Nothing__ctor__fn(Nothing* __this)
{
    __this->ctor_();
}

// private Nothing New() :1408
void Nothing__New1_fn(Nothing** __retval)
{
    *__retval = Nothing::New1();
}

// private Nothing() [instance] :1408
void Nothing::ctor_()
{
}

// private Nothing New() [static] :1408
