...
// public static Java.Object get_Handle() :310
...
// public static Java.Object get_Handle() [static] :310
...
::g::Fuse::Controls::GraphicsView_type* RootGraphicsView_typeof()
{
    ...
    type->interface17.fp_get_ProjectionTransform = (void(*)(uObject*, ::g::Uno::Float4x4*))::g::Fuse::Controls::GraphicsView__get_ProjectionTransform_fn;
    ...
    type->interface17.fp_get_ViewOrigin = (void(*)(uObject*, ::g::Uno::Float3*))::g::Fuse::Controls::GraphicsView__get_ViewOrigin_fn;
    type->interface17.fp_get_ViewRange = (void(*)(uObject*, ::g::Uno::Float2*))::g::Fuse::Controls::GraphicsView__get_ViewRange_fn;
    ...
    type->interface20.fp_get_PixelSize = (void(*)(uObject*, ::g::Uno::Float2*))::g::Fuse::Controls::GraphicsView__get_PixelSize_fn;
    type->interface20.fp_get_ViewTransform = (void(*)(uObject*, ::g::Uno::Float4x4*))::g::Fuse::Controls::GraphicsView__get_ViewTransform_fn;
...
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "GetWidth347", "(Ljava/lang/Object;)I");
        ::g::Java::Object* _uhandle=handle;
        jobject _handle = (_uhandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_uhandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
        jint __jresult = U_JNIVAR->CallStaticIntMethod(__cls,__mtd,_handle);
        int __result = (int)__jresult;
...
static void StatusBarConfig_build(uType* type)
{
    ...
    ::STRINGS[2] = uString::Const("C:\\Users\\Lotus\\AppData\\Local\\Fusetools\\Packages\\Fuse.Android\\1.2.0\\$.uno");
...
void StatusBarConfig::Color(::g::Uno::Float4 value)
{
    if (!StatusBarConfig::SetStatusBarColor(value))
        ::g::Fuse::Diagnostics::UserWarning(::STRINGS[1/*"StatusBarCo...*/], this, ::STRINGS[2/*"C:\\Users\\...*/], 111, ::STRINGS[3/*"set_Color"*/]);
}
...
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "GetStatusBarColor348", "()I");
