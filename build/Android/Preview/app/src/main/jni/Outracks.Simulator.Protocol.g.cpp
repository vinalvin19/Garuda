...
static void Error_build(uType* type)
{
    ...
    ::STRINGS[12] = uString::Const("C:/Users/Lotus/AppData/Local/Fusetools/Packages/Outracks.Simulator.Common.Uno/0.0.0/messages/$.uno");
...
Error* Error::ReadDataFrom(::g::System::IO::BinaryReader* reader)
{
    ...
    Error_typeof()->Init();
    ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[11/*"Read Error"*/], 0, ::STRINGS[12/*"C:/Users/Lo...*/], 572);
