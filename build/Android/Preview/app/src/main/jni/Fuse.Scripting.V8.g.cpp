...
static void Debugger__Connected_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("C:/Users/Lotus/AppData/Local/Fusetools/Packages/Fuse.Scripting.V8/1.2.0/$.uno");
...
void Debugger__Connected::ctor_(::g::Fuse::Scripting::V8::Debugger* parent, ::g::Uno::Net::Sockets::Socket* socket, ::g::Uno::IO::TextReader* reader)
{
    ...
    ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[0/*"DEBUG_V8: C...*/], 0, ::STRINGS[1/*"C:/Users/Lo...*/], 635);
    _parent = parent;
    _socket = socket;
    _reader = reader;
}
...
static void Debugger_build(uType* type)
{
    ...
    ::STRINGS[20] = uString::Const("1.2.0");
...
uObject* Debugger::Connect(Debugger* parent)
{
    ...
    ::g::Uno::Diagnostics::Debug::Log5(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[14/*"DEBUG_V8: W...*/], uBox<int>(::TYPES[19/*int*/], parent->_port)), ::STRINGS[15/*"..."*/]), 0, ::STRINGS[1/*"C:/Users/Lo...*/], 476);
